namespace Fusion.Addons.KCC
{
	...
	public sealed partial class KCCSettings
	{
		...
		[Tooltip("Forces render prediction of look rotation for input authority. Can be used for extra look responsiveness with other properties being interpolated.")]
